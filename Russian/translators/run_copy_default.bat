...
XMLCompare /s D:\Android\XMLCompare\SRC\strings.xml /d D:\Android\XMLCompare\DST\strings.xml /i D:\Android\XMLCompare\ignore.xml /t D:\Android\XMLCompare\TRS\strings.xml /n 4
